...
If the range of the ADC is for not to be in the range 0 to 1023 (it is typically limited to around 940), then replace the 22$\Omega$ resistor by a wire link as noted in @refer-back.
