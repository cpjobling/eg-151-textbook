...
If you look in @lst-listing6, you will find a simple programme which
...
need to be made to the programme in @lst-listing7:
...
Create a new Arduino sketch and modify the programme from @lst-listing7.
...
-   A listing of your programme for @sec-ex3-exercise above, with comments as
    appropriate.
