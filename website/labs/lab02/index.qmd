...
All the programme examples in [Experiment 1](../lab01) dealt with digital output,
...
The demonstration programme in @lst-ex2-1 is, in fact, the very first
...
The next programme, in @lst-ex2-2, uses both buttons. The left-hand
...
A new programme structure, `if...else` has been introduced @lst-ex2-2 (lines 28&mdash;33) is used to decide on a delay of 1000 ms
...
Modify the programme in @lst-ex2-2 so that the buttons have this
effect:
...
-   A photograph of the modified breadboard, with some form of
    identification.
-   A listing of your final programme (as specified in @sec-section-5 above)
