...
The demonstration programin @lst-ex2-1 is, in fact, the very first
programwe tried in Experiment 1. There is one refinement; a switch is
...
-   A photograph of the modified breadboard, with some form of
    identification.
-   A listing of your final program (as specified in @sec-section-5 above)
