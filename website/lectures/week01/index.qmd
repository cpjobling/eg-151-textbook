...
::: {.notes}
[Presentation version](/_slides/lecture00.html) of these [notes](#week1:introduction).
:::
...
::: {#fig-apps}
![](http://lreese.dotsenkoweb.com/wp-content/uploads/2019/04/Fig-1-VennDiagraml-1024x713.jpg){fig-alt="Venn diagram of the applications of the 8-bit MCU vs. the 32-bit MC" width="75%"}
...
The Von Neumann architecture&mdash;data memory and programme code use the same memory storage area and data busses
:::
...
::: {#fig-week1-harvard}
![](pictures/harvard_arch.png){fig-alt="The Harvard architecture - data memory and programme code use different memory storage areas and busses."}

The Harvard architecture&mdash;data memory and programme code use different memory storage areas and busses.
:::
...
![](pictures/modified_harvard.png){fig-alt="The modified Harvard architecture - data memory and programme code use the same memory storage area, but data and program addresses use separate busses to access the memory."}

The Harvard architecture&mdash;data memory and programme code use the same memory storage area, but data and program addresses use separate busses to access the memory.
:::
...
Next week we will look at [Data Representation](https://cpjobling.github.io/eg-151-textbook/lectures/data_representation/).
