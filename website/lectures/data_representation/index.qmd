...
- Characters which are represented as ASCII code (7 bits), extended ASCII (8 bits) or UTF (16 or more bits) used to represent other characters (e.g. for accented characters, other alphabets and languages, math symbols, emojis) and other purposes.
...
We will look at the status register in detail in [rchitecture of the Atmel ATmega 328 Microcontroller](../week02/).
