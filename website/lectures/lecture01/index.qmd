...
## 50 years of teaching microprocessors at Swansea![^acknowledgements] {#week1:introduction}
...
## Topics Covered in this Lecture {#week1:toc}

![](pictures/slide2.png){img-alt="A decorative image showing code, a microntroller chip and the Arduino nano microcontroller board used in the lab component of this module." width=50%}

- [What is a Microcontroller?](#week1:what_is_a_uc)
- [Where are Microcontrollers Used?](#where_are_uc_used)
...
## Where are Microcontrollers Used? {#week1:where_are_uc_used}

::: {#fig-uses_of_micros}

![](pictures/uses_of_micros.png){fig-alt="An image illustrating that microcontrollers are used in the automotive industry, cosnumer electronics, industrial and control sytems, and environmental monitoring"}
...
Automotive applications of microcontrollers[^note1]
:::

[^note1]: Source of original image used in @fig-automotive-apps: [www.linkedin.com/pulse/microcontrollers-used-automotive-applications-field-amin-agina](https://www.linkedin.com/pulse/microcontrollers-used-automotive-applications-field-amin-agina). The original image is no longer accessible.
...
## How do we Describe Microcontrollers?{#week1:architecture}
...
::: {#fig-week1-vonneuman}
![](pictures/von_neuman_arch.png){fig-alt="The Von Neumann architecture - data memory and programme code use the same memory storage area and data busses."}
...
::: {#fig-week1-harvard}
![](pictures/harvard_arch.jpg){fig-alt="The Harvard architecture - data memory and programme code use different memory storage areas and busses."}
...
![](pictures/mem_arch.png){fig-alt="Classification of microcontrollers systems."}
...
## The Atmel ATmega 328 Microcontroller {#atmel_atmega328}
...
Next week we will look at [Data Representation](../data_representation/).
