...
These are discussed in the next section @sec-wk4-flow-control.

---

## Flow control {#sec-wk4-flow-control}
...
### The *for* statement in C {#sec-wk4-arithmetic-ops}
...
Here is an actual *for* loop which solves the problem given in @sec-wk4-sum_example` it better illustrates how it might be written in a real program:
