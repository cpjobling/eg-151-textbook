...
---
::: {.notes}
[Presentation version](/slides/lecture03.html) of these [notes](#sec-week02-intro).
:::
...
(week02:io)=
::: {.center}
## The Status Register{background-image="pictures/wallpaper.png" fig-alt="decorative image used for slide background [wallpaper.dog/microcontroller-wallpapers](https://wallpaper.dog/microcontroller-wallpapers)" #sec-week02-status-register}
:::
