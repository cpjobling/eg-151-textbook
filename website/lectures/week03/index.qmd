...
![](pictures/chapter_heading.png){width="100%" fig-alt="lecture cover image showing architecture, some gates and an Arduino nano board"}
...
::: {.column width="25%"}
![](pictures/contents_image.png){img-alt="A decorative image showing code, a microntroller chip and the Arduino nano microcontroller board used in the lab component of this module." width=100%}
:::

::: {.column width="75%"}
- @sec-week03-intro: [Application Development](#sec-week03-intro)
...
## Application Development{#sec-week03-intro}
...
::: {.center}
## Flowcharts{#sec-week03-flowcharts fig-alt="A flowchart" background-image="https://upload.wikimedia.org/wikipedia/commons/a/a6/Flowchart_structured_programming.svg" background-color="white"}
:::

::: {.notes}
![](https://upload.wikimedia.org/wikipedia/commons/a/a6/Flowchart_structured_programming.svg){fig-alt="A flowchart"} 
...
![](pictures/flowchart_hello_world.png){width="30%" fig-alt="A flowchart representing the hellow world program."}
...
### Example 1: A sequence{.unnumbered}
...
### Example 2: Decision and a Loop{.unnumbered #sec-week03:sum-example}
...
### Another Example Program{.unnumbered}
...
::: {#fig-week03-sic} 
![](pictures/sic.png){fig-alt="Variation 6 - Sum - Increment - Check" width="30%"}
...
::: {#fig-week03-isc} 
![](pictures/isc.png){fig-alt="Variation 4 - Increment - Sum - Check" width="30%"}
...
::: {#fig-week03-cis} 
![](pictures/cis.png){fig-alt="Variation 2 - Check - Increment - Sum" width="30%"}
