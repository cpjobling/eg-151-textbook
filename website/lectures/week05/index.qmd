...
- @sec-wk5-bit-masking: [Bit masking](#sec-wk5-bit-masking)

- @sec-wk5-digital-io-example: [Digital I/O example using LEDs and push buttons](sec-wk5-digital-io-example)
...
::: {.center}
## How does I/O work using the Arduino IDE {#sec-wk5-arduino_ide background-image="pictures/arduino_nano_wallpaper.jpg"}
:::
