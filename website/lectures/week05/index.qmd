...
![](pictures/dd.gif){fig-alt="Video illustrating the setting up of the data direction registers."}
...
![](pictures/pullup.gif){fig-alt="Video illustrating the setting of the port D for input and resetting port B."}
...
![](pictures/buttons.gif){fig-alt="Video showing how the state of the buttons is interogated using bit masks."}
